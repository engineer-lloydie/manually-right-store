import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance as getCurrentInstance$1, toRef, inject as inject$1, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, ref, computed, capitalize, watchEffect, toRefs, Fragment, isVNode, Comment, unref, watch, provide, onScopeDispose, warn, h, defineComponent as defineComponent$1, createVNode, mergeProps, defineAsyncComponent, Suspense, nextTick, readonly, withCtx, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from 'vue';
import { k as createHooks, l as getContext, i as createError$1, m as toRouteMatcher, n as createRouter, o as defu$1, q as hasProtocol, r as joinURL, w as withQuery, v as sanitizeStatusCode, x as isScriptProtocol, y as executeAsync, z as getRequestHeaders, A as defuFn, B as klona, d as destr, C as getRequestHeader, D as isEqual$1, E as setCookie, F as getCookie, G as deleteCookie, H as getRequestURL, I as getResponseHeaders, J as splitCookiesString, K as setResponseHeaders, L as FetchError } from '../_/nitro.mjs';
...
const _routes = [
  ...
  },
  {
    ...
    component: () => import('./checkout.vue.mjs')
  },
  {
    name: "contact-us",
    path: "/contact-us",
    meta: __nuxt_page_meta$7 || {},
    component: () => import('./contact-us.vue.mjs')
  },
  {
    name: "payment-success",
    path: "/payment-success",
    meta: __nuxt_page_meta$6 || {},
    component: () => import('./payment-success.vue.mjs')
  },
  {
  ...
  },
  {
    ...
    component: () => import('./terms-and-conditions.vue.mjs')
  },
  {
    name: "manuals-categories-main_category_slug",
    path: "/manuals/categories/:main_category_slug()",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./index.vue3.mjs')
  },
  {
    name: "manuals-categories-main_category_slug-sub_category_slug",
    path: "/manuals/categories/:main_category_slug()/:sub_category_slug()",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./index.vue4.mjs')
  },
  {
    name: "manuals-categories-main_category_slug-sub_category_slug-product_slug",
    path: "/manuals/categories/:main_category_slug()/:sub_category_slug()/:product_slug()",
    meta: __nuxt_page_meta || {},
    component: () => import('./_product_slug_.vue.mjs')
  }
];
...
const validate$1 = defineNuxtRouteMiddleware(async (to) => {
  var _a;
...
const namedMiddleware = {
  "sanctum:auth": () => import('./sanctum.auth.mjs'),
  "sanctum:guest": () => import('./sanctum.guest.mjs')
};
...
const plugin_amcCQ2WESqorJPIcCBfr0SoJux9Ycqp__WbI4xOJhLc = defineNuxtPlugin(async (nuxtApp) => {
  let __temp, __restore;
...
function isWindows$1(userAgent) {
...
function generateFlags(userAgent, headers = {}) {
  ...
  const windows = isWindows$1(userAgent);
...
const plugin_vz9iHc7_bD8KQzUq6ZprTRfi1svzocRN0YrDyAJWMCk = defineNuxtPlugin(() => {
...
function isPojoOrArray(val) {
  var _a;
  return Array.isArray(val) || !!val && typeof val === "object" && ((_a = val.constructor) == null ? void 0 : _a.name) === "Object";
}
...
function appendRequestHeaders(headers, append) {
...
function useServerHeaders(headers, config, logger) {
...
async function handleRequestCookies(app, ctx, logger) {
  ...
  const method = ((_a = ctx.options.method) == null ? void 0 : _a.toLowerCase()) ?? "get";
  {
...
async function handleRequestHeaders(app, ctx, logger) {
  var _a;
  const method = ((_a = ctx.options.method) == null ? void 0 : _a.toLowerCase()) ?? "get";
...
async function validateResponseHeaders(app, ctx, logger) {
  ...
  const headers = (_a = ctx.response) == null ? void 0 : _a.headers;
  if (!headers) {
...
function useClientInterceptors(options, appConfig) {
  var _a, _b;
  ...
  if ((_a = appConfig.interceptors) == null ? void 0 : _a.onRequest) {
...
async function setupDefaultTokenStorage(nuxtApp, logger) {
  ...
  const defaultStorage = await import('./cookieTokenStorage.mjs');
...
async function initialIdentityLoad(client, options, logger) {
  const user = useSanctumUser();
...
const plugin_qFoR2KwrfPbeYF1NbvQtNji8ub5JyA6jqzexZ5yyjV8 = defineNuxtPlugin({
  ...
  async setup(_nuxtApp) {
    ...
    if (options.client.initialRequest) {
      [__temp, __restore] = executeAsync(() => initialIdentityLoad(client, options, logger)), await __temp, __restore();
    }
    return {
      provide: {
...
const modal_Cp9ldknJIJzgGxAM8IcUNyTLBviU0lMcL0mANIL45Sw = defineNuxtPlugin((nuxtApp) => {
...
const useSanctumAuth = () => {
  ...
  async function login(credentials) {
    ...
    if (isAuthenticated.value) {
      ...
      await nuxtApp.runWithContext(
        async () => await navigateTo(options.redirect.onLogin)
      );
    }
  ...
  async function logout() {
    ...
    await nuxtApp.runWithContext(
      async () => await navigateTo(options.redirect.onLogout)
    );
  }
  return {
    user,
...
const useBaseFetch = async (request, opts) => {
...
const auth_ljVnFG_dl63lUHlHR3X1ynuC3el03CDMa3IoWa4Ichk = defineNuxtPlugin((nuxtApp) => {
...
const url_slug_EKy98GhxQLngksdMmYZ6zvVuvLiN9wgQfetWACImUoE = defineNuxtPlugin((nuxtApp) => {
...
/* empty css                                                     */
/* empty css                   */
const vuetify_5gmD7e9xnMgh0QGWrZjiZxV6kIGPZbjuquYjboXWgEQ = defineNuxtPlugin((app) => {
...
const plugins = [
  ...
  modal_Cp9ldknJIJzgGxAM8IcUNyTLBviU0lMcL0mANIL45Sw,
  auth_ljVnFG_dl63lUHlHR3X1ynuC3el03CDMa3IoWa4Ichk,
  url_slug_EKy98GhxQLngksdMmYZ6zvVuvLiN9wgQfetWACImUoE,
  vuetify_5gmD7e9xnMgh0QGWrZjiZxV6kIGPZbjuquYjboXWgEQ
];

const layouts = {
  default: defineAsyncComponent(() => import('./default.vue.mjs').then((m) => m.default || m)),
  "footer-menu": defineAsyncComponent(() => import('./footer-menu.vue.mjs').then((m) => m.default || m)),
  "header-menu": defineAsyncComponent(() => import('./header-menu.vue.mjs').then(function (n) { return n.h; }).then((m) => m.default || m))
};
...
export { createError as $, useDisplay as A, isOn as B, provideTheme as C, makeThemeProps as D, EventProp as E, makeComponentProps as F, getPropertyFromItem as G, provideDefaults as H, IconValue as I, getUid as J, omit as K, useBaseFetch as L, filterInputAttrs as M, callEvent as N, useRoute as O, useSeoMeta as P, useRtl as Q, useResizeObserver as R, createRange as S, keyValues as T, matchesSelector as U, ensureValidVNode as V, checkPrintable as W, debounce as X, isObject as Y, useToggleScope as Z, asyncDataDefaults as _, useCookie as a, defineNuxtRouteMiddleware as a0, useSanctumConfig as a1, trimTrailingSlash as a2, useModalStore as a3, useLayout as a4, VApp as a5, keys as a6, useGoTo as a7, focusableChildren as a8, makeLayoutItemProps as a9, server as aA, useLayoutItem as aa, useTheme as ab, pickWithRest as ac, isClickInsideElement as ad, focusChild as ae, getNextElement as af, isPrimitive as ag, pick as ah, defineComponent as ai, deprecate as aj, getCurrentInstanceName as ak, consoleWarn as al, destructComputed as am, defer as an, templateRef as ao, breakpoints as ap, findChildrenWithProvide as aq, hasEvent as ar, includes as as, keyCodes as at, useIcon as au, flattenFragments as av, isCssColor as aw, isParsableColor as ax, parseColor as ay, getForeground as az, useRouter as b, useNuxtApp as c, useRuntimeConfig as d, nuxtLinkDefaults as e, useHead as f, genericComponent as g, useProxiedModel as h, useLocale as i, useRender as j, convertToUnit as k, useCartStore as l, useSanctumAuth as m, navigateTo as n, clamp as o, propsFactory as p, getCurrentInstance as q, resolveRouteObject as r, defineFunctionalComponent as s, consoleError as t, useRequestURL as u, deepEqual as v, wrapInArray as w, getObjectValueByPath as x, isEmpty as y, makeDisplayProps as z };
