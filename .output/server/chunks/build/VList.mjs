import { computed, shallowRef, watchEffect, inject, provide, toRaw, ref, toRef, createVNode, withDirectives, vShow, watch, mergeProps, Fragment, toDisplayString, resolveDirective } from 'vue';
import { b as VExpandTransition } from './index.mjs';
import { p as propsFactory, ag as isPrimitive, ah as pick, v as deepEqual, G as getPropertyFromItem, K as omit, w as wrapInArray, h as useProxiedModel, q as getCurrentInstance, J as getUid, t as consoleError, g as genericComponent, j as useRender, ai as defineComponent, F as makeComponentProps, I as IconValue, C as provideTheme, D as makeThemeProps, E as EventProp, aj as deprecate, H as provideDefaults, ae as focusChild } from './server.mjs';
import { u as useSsrBoot } from './ssrBoot.mjs';
import { m as makeTagProps, e as useBorder, h as useDimension, f as useElevation, g as useRounded, a as makeRoundedProps, b as makeElevationProps, i as makeDimensionProps, c as makeBorderProps, d as useTextColor, u as useBackgroundColor } from './position.mjs';
import { M as MaybeTransition, i as createSimpleFunctional, g as VAvatar } from './VCard.mjs';
import { V as VDefaultsProvider, R as Ripple, j as useLink, h as useVariant, d as useDensity, f as makeVariantProps, l as makeRouterProps, e as makeDensityProps, k as genOverlays, c as VIcon } from './VProgressCircular.mjs';
...
export { VList as V, VListItem as a, VListItemTitle as b, makeItemsProps as m, useItems as u };
