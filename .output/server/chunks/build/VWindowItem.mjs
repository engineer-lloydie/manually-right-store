import { ref, computed, shallowRef, watch, provide, createVNode, withDirectives, resolveDirective, inject, vShow, nextTick } from 'vue';
import { a6 as keys, g as genericComponent, p as propsFactory, C as provideTheme, Q as useRtl, i as useLocale, j as useRender, D as makeThemeProps, F as makeComponentProps, k as convertToUnit } from './server.mjs';
import { c as useGroup, V as VBtn, u as useGroupItem, m as makeGroupItemProps } from './VBtn.mjs';
import { u as useLazy, m as makeLazyProps } from './lazy.mjs';
import { u as useSsrBoot } from './ssrBoot.mjs';
import { M as MaybeTransition } from './VCard.mjs';
import { m as makeTagProps } from './position.mjs';
