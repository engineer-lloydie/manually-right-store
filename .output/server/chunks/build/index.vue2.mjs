...
import { L as useBaseFetch } from './server.mjs';
          ...
          if (_push2) {
            _push2(ssrRenderComponent(VCardTitle, { class: "mb-5" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Main Categories`);
                } else {
                  return [
                    createTextVNode("Main Categories")
                  ];
                }
              }),
              _: 1
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (unref(fetching)) {
                    ...
                    _push3(`<!--[-->`);
                    if (!unref(mainCategories).length) {
                      ...
                      _push3(ssrRenderComponent(VRow, null, {
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(`<!--[-->`);
                            ssrRenderList(unref(mainCategories), (item, i) => {
                              _push4(ssrRenderComponent(VCol, {
                                key: i,
                                cols: "12",
                                md: "6",
                                        ...
                                        if (_push6) {
                                          _push6(ssrRenderComponent(VIcon, {
                                            ...
                                            default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                              if (_push7) {
                                                _push7(`mdi-folder-file-outline`);
                                              } else {
                                                return [
                                                  createTextVNode("mdi-folder-file-outline")
                                                ];
                                              }
                                            }),
                                            _: 2
                            ...
                            return [
                              (openBlock(true), createBlock(Fragment, null, renderList(unref(mainCategories), (item, i) => {
                  ...
                  return [
                    unref(fetching) ? (openBlock(), createBlock(VRow, { key: 0 }, {
                      ...
                      !unref(mainCategories).length ? (openBlock(), createBlock("p", {
                        key: 0,
                        class: "text-center"
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/manuals/categories/index.vue");
